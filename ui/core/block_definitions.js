...
Blockly.Blocks['led_green'] = {
  init: function() {
    this.appendValueInput("value")
      ...
      .setCheck(null)
      .setAlign(Blockly.ALIGN_RIGHT)
      .appendField("みどりいろLED");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(40);
 this.setTooltip("みどりいろLED");
 this.setHelpUrl("bipes.net.br");
  }
};
Blockly.Blocks['led_blue'] = {
  init: function() {
    ...
    this.setNextStatement(true, null);
    this.setColour(40);
 this.setTooltip("あおいろLED");
 this.setHelpUrl("bipes.net.br");
  }
};

Blockly.Blocks['pwm_led_red'] = {
  init: function(){
    this.appendDummyInput()
      .appendField(new Blockly.FieldImage(
        "media/LED_RED.jpg",
    ...
    this.appendValueInput("duty")
        .setCheck("Number")
	      .appendField("あかるさちょうせい(0～100%)");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(40);
    this.setTooltip("あかいろLEDのあかるさを0～100%でちょうせいします");
 }
};

Blockly.Blocks['pwm_led_green'] = {
  init: function(){
    this.appendDummyInput()
      .appendField(new Blockly.FieldImage(
        "media/LED_GREEN.jpg",
    ...
    this.setNextStatement(true, null);
    this.setColour(40);
    this.setTooltip("みどりいろLEDのあかるさを0～100%でちょうせいします");
 }
};

Blockly.Blocks['pwm_led_blue'] = {
  init: function(){
      this.appendDummyInput()
      .appendField(new Blockly.FieldImage(
        "media/LED_BLUE.jpg",
    ...
    this.setNextStatement(true, null);
    this.setColour(40);
    this.setTooltip("あおいろLEDのあかるさを0～100%でちょうせいします");
 }
};
...
Blockly.Blocks['neopixel_rotate_left'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabel("NeoPixelを反とけいまわりさせる"), "MSG_NEOPIXEL");
    ...
    this.setColour(40);
 this.setTooltip("NeoPixelを反とけいまわりさせる");
  }
};
...
Blockly.Blocks['neopixel_rotate_right'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabel("NeoPixelをとけいまわりさせる"), "MSG_NEOPIXEL");
    ...
    this.setColour(40);
 this.setTooltip("NeoPixelをとけいまわりさせる");
  }
};
